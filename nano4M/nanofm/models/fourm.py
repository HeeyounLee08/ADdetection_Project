...
class FourM(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.enc_tok_emb = nn.Embedding(num_embeddings=self.vocab_size, embedding_dim=dim,)
    ...
    def generate_one_modality_roar(
        ...
        rand_perm = torch.randperm(n_tokens_target, device=device) 
        ...
        for k in schedule:
            dec_input_positions_list.append(rand_perm[idx : idx + k].unsqueeze(0))  # [1, k]
            idx += k
